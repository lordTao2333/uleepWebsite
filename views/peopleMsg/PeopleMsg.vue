	...
	<div class="moreMsg">
		...
		<div class="moreMsgBeyondBox">
			<div class="moreMsgBeyondInnerBox">
				<div class="moreMsgBeyondInnerBoxBotton" @click="$router.push('/peopleQuestion')">
					提交问卷
				</div>
				<div class="moreMsgBeyondInnerBoxBotton" @click="speak()">
					语音识别
				</div>
...
<script>
	...
	import { annyang } from "../../../public/js/annyang.min.js"
...
<style scoped="scoped">
	.moreMsg{
		background: rgba(168, 199, 225, 1.0);
		height: 100%;
		width: 100%;
	...
	.moreMsgMiddleBox{
		height: 60px;
		display: flex;
		border-bottom: rgba(136, 176, 214, 1.0) 1px solid;
	}
